...
- Виджет адаптивен - min-width: 375px
...
- Возможность скрывать/показывать данные каждой категории на графике доступна "из коробки" для библиотеки Chart.js - достаточно кликнуть по самой категории